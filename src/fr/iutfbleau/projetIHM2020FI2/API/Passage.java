...
public interface Passage extends Activable, Descriptible {
    ...
    /**
     * Permet de récupérer un objet permettant de faire un dessin du passage 
     *
     ...
     * @return Path2D
     */
    default public Path2D getPosition(){
        return null;
    }

    /**
     * Permet de MàJ un objet permettant de faire un dessin du passage 
     *
     * Comme il s'agit d'une extension de l'API originale, nous utilisons le mécanisme des méthodes par défaut 
     * pour assurer la rétro-compatibilité. 
     *
     */
    default public void  setPosition(Path2D p){
